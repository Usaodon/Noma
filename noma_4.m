function [ber1,ber2] = noma_4(user)
...
h_close=LTEMultipathSig(1/8/256000,8160,'EPA');
h_far=LTEMultipathSig(1/8/256000,8160,'EVA');
...
%out_close=0.8*out_1;
%out_far=0.6*out_1;
output_close=zeros(7,8160);
output_far=zeros(7,8160);
for i=1:7
...
for i=1:7
    ...
    re_data=re_data.';
for i=1:7
    y_close(i,:)=(y_close(i,:)-re_data*0.8);
end
    
    
    
    %y_close=y_close-y_far;
    y_close_2=zeros(1,8160);
